        ...
        <section className="relative overflow-hidden bg-[#fbfaff] px-4 pb-14 pt-10 sm:px-6 sm:pb-18 sm:pt-12 lg:px-10 lg:pb-24 lg:pt-11">
          ...
          <div className="relative mx-auto grid w-full max-w-[1320px] min-w-0 items-center gap-9 sm:gap-12 lg:grid-cols-[minmax(0,0.92fr)_minmax(0,1.08fr)]">
            ...
            <div className="relative mt-1 min-h-[300px] min-w-0 sm:mt-0 sm:min-h-[470px] lg:min-h-[540px]">
              <div className="pointer-events-none absolute left-1/2 top-1/2 hidden h-[300px] w-[300px] -translate-x-1/2 -translate-y-1/2 rounded-full border border-dashed border-[#cfc5ff] sm:block sm:h-[400px] sm:w-[400px] lg:h-[470px] lg:w-[470px]" />
              ...
              <Image
                ...
                priority
                unoptimized
                className="absolute left-1/2 top-1/2 z-20 h-auto w-[94%] max-w-full -translate-x-1/2 -translate-y-1/2 object-contain drop-shadow-[0_30px_45px_rgba(32,23,92,0.18)] sm:w-[86%] xl:max-w-[590px]"
              />

              <div style={{ animationDelay: "0s" }}
                className="cloud-float-card absolute left-[0%] top-[8%] z-30 hidden w-[215px] rounded-[22px] border border-[#e5e0f1] bg-white/95 p-4 shadow-[0_18px_42px_rgba(35,27,84,0.11)] backdrop-blur lg:block">
                <div className="flex items-center gap-3">
              ...
              <div style={{ animationDelay: "0.7s" }}
                className="cloud-float-card absolute right-[0%] top-[18%] z-30 hidden w-[215px] rounded-[22px] border border-[#e5e0f1] bg-white/95 p-4 shadow-[0_18px_42px_rgba(35,27,84,0.11)] backdrop-blur lg:block">
                <div className="flex items-center gap-3">
              ...
              <div style={{ animationDelay: "1.4s" }}
                className="cloud-float-card absolute bottom-[8%] left-[3%] z-30 hidden w-[215px] rounded-[22px] border border-[#e5e0f1] bg-white/95 p-4 shadow-[0_18px_42px_rgba(35,27,84,0.11)] backdrop-blur lg:block">
                <div className="flex items-center gap-3">
              ...
              <div style={{ animationDelay: "2.1s" }}
                className="cloud-float-card absolute bottom-[2%] right-[1%] z-30 hidden w-[215px] rounded-[22px] border border-[#e5e0f1] bg-white/95 p-4 shadow-[0_18px_42px_rgba(35,27,84,0.11)] backdrop-blur lg:block">
                <div className="flex items-center gap-3">
              ...
              {cloudFeatures.map((feature, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div>
                      <span className="text-[14px] font-extrabold leading-none tracking-[0.02em] text-[#ff2f7d]">
        ...
        <section className="px-4 py-8 sm:px-8 lg:px-10">
          <div className="relative mx-auto max-w-[1440px] overflow-hidden rounded-[21px] bg-[#041033] px-5 py-12 text-white shadow-[0_28px_75px_rgba(4,10,35,0.24)] sm:rounded-[24px] sm:px-8 sm:py-16 lg:px-14 lg:py-20">
            ...
            <div className="relative z-10 mx-auto max-w-[800px] text-center">
              ...
              <p className="mx-auto mt-5 max-w-[690px] text-[16px] font-medium leading-7 text-white/82">
          ...
          <div data-service-reveal className="relative mx-auto max-w-[1320px] overflow-hidden rounded-[22px] bg-[linear-gradient(105deg,#061330_0%,#17104b_42%,#5e155b_75%,#ff2f7d_125%)] px-5 py-10 text-white shadow-[0_24px_60px_rgba(11,10,48,0.24)] sm:rounded-[26px] sm:px-8 sm:py-12 lg:px-14">
            ...
            <div className="relative z-10 flex flex-col items-start justify-between gap-8 lg:flex-row lg:items-center">
              <div>
                ...
                <p className="mt-3 max-w-[660px] text-[15px] font-medium leading-7 text-white/84">
