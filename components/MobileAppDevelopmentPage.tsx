...
const capabilities = [
  {
    ...
    description:
      "High-performance mobile applications designed specifically for iOS and TabletSmartphone platforms.",
...
const technologies = [
  ...
  },
  {
    ...
    title: "TabletSmartphone Development",
    items: ["Kotlin", "Java", "TabletSmartphone Studio", "Jetpack", "Google Play"],
  },
  {
...
const benefits = [
  ...
  "iOS and TabletSmartphone platform support",
...
const faqs = [
  {
    ...
    answer:
      "The right approach depends on application complexity, performance requirements, timeline, budget and required device features. We evaluate your requirements before recommending native iOS and TabletSmartphone development or a cross-platform solution.",
  },
  {
        ...
        <section className="relative overflow-hidden bg-[#fbfaff] px-5 pb-20 pt-16 sm:px-8 lg:px-10 lg:pb-24 lg:pt-20">
          ...
          <div className="relative mx-auto grid max-w-[1320px] items-center gap-12 lg:grid-cols-[0.92fr_1.08fr]">
            ...
            <div className="relative z-20">
              ...
              <h1 className="mt-7 max-w-[670px] text-[44px] font-bold leading-[1.07] tracking-[-0.05em] text-[#081232] sm:text-[56px] lg:text-[66px]">
                Mobile Experiences
            ...
            <div className="relative min-h-[540px]">
              ...
              <div className="pointer-events-none absolute left-1/2 top-1/2 h-[380px] w-[380px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-[radial-gradient(circle,rgba(75,34,255,0.14),transparent_67%)]" />
              ...
              <Image
                ...
                priority
                unoptimized
                className="absolute left-1/2 top-1/2 z-20 w-[82%] max-w-[560px] -translate-x-1/2 -translate-y-1/2 object-contain drop-shadow-[0_30px_45px_rgba(32,23,92,0.18)]"
              />
          ...
          <div className="mx-auto max-w-[1320px]">
            <div className="mx-auto max-w-[780px] text-center">
              ...
              <h2 className="mt-4 text-[34px] font-bold tracking-[-0.04em] text-[#081232] sm:text-[44px]">
                ...
                <span className="text-[#4b22ff]">Real User Needs</span>
              </h2>
          ...
          <div className="mx-auto grid max-w-[1320px] items-center gap-14 lg:grid-cols-[0.85fr_1.15fr]">
            <div>
              ...
              <h2 className="mt-4 max-w-[580px] text-[34px] font-bold leading-[1.16] tracking-[-0.04em] text-[#081232] sm:text-[44px]">
                Everything Your Mobile Product
                <span className="block text-[#ff315d]">
                  Needs to Perform
                </span>
              </h2>
          ...
          <div className="mx-auto max-w-[1320px]">
            <div className="mx-auto max-w-[780px] text-center">
              ...
              <h2 className="mt-4 text-[34px] font-bold tracking-[-0.04em] text-[#081232] sm:text-[44px]">
                ...
                <span className="text-[#ff315d]">App Store Launch</span>
              </h2>
          ...
          <div className="relative mx-auto grid max-w-[1320px] items-center gap-14 lg:grid-cols-[0.85fr_1.15fr]">
            <div>
              ...
              <h2 className="mt-4 max-w-[580px] text-[34px] font-bold leading-[1.16] tracking-[-0.04em] text-[#081232] sm:text-[44px]">
                ...
                <span className="text-[#4b22ff]">Long-Term Growth</span>
              </h2>
            ...
            <div className="relative z-10 flex flex-col items-start justify-between gap-8 lg:flex-row lg:items-center">
              <div>
                ...
                <p className="mt-3 max-w-[650px] text-[13px] font-medium leading-7 text-white/65">
                  ...
                  roadmap for your iOS, TabletSmartphone or cross-platform application.
                </p>
              </div>
