    ...
    <>
      <main className="overflow-hidden bg-white font-sans text-[#07112f] antialiased">
        ...
        <section className="relative overflow-hidden bg-[#fbfaff] px-4 pb-12 pt-10 sm:px-6 sm:pb-16 sm:pt-12 lg:px-10 lg:pb-20 lg:pt-11">
          ...
          <div className="pointer-events-none absolute -right-40 top-[-100px] h-[500px] w-[500px] rounded-full bg-[#ff2f7d]/10 blur-[135px]" />
          ...
          <div className="relative mx-auto grid max-w-[1320px] items-center gap-10 sm:gap-12 lg:grid-cols-[0.92fr_1.08fr] lg:gap-14">
            <div className="relative z-20">
              ...
              <p className="mt-5 max-w-[650px] text-[16px] font-medium leading-7 text-[#27314f]/90 sm:mt-7 sm:text-[17px] sm:leading-[1.8]">
              ...
              <div className="mt-7 flex flex-col gap-3 sm:mt-8 sm:flex-row sm:flex-wrap sm:gap-4">
                <button
                  ...
                  className="group inline-flex min-h-[48px] w-full cursor-pointer items-center justify-center gap-3 rounded-[10px] bg-gradient-to-r from-[#4525ff] to-[#ff315f] px-6 text-[14px] font-bold text-white shadow-[0_12px_28px_rgba(80,45,255,0.28)] transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_18px_36px_rgba(80,45,255,0.34)] sm:w-auto sm:px-7"
                >
                  Work With Our Team
              ...
              <div className="absolute left-1/2 top-1/2 z-20 w-full max-w-[580px] -translate-x-1/2 -translate-y-1/2 rounded-[24px] border border-white/70 bg-white p-3 shadow-[0_35px_80px_rgba(38,25,104,0.20)] sm:w-[88%] sm:rounded-[30px] sm:p-4">
                <div className="relative min-h-[350px] overflow-hidden rounded-[20px] bg-[linear-gradient(145deg,#061330_0%,#1d1059_52%,#8a1c78_115%)] p-5 text-white sm:min-h-[390px] sm:rounded-[24px] sm:p-9">
                  ...
                  <div className="relative z-10">
                    <p className="text-[12px] font-bold uppercase tracking-[0.28em] text-[#ff7ca8]">
                      <TypewriterText
                    ...
                    <p className="mt-4 max-w-[420px] text-[14px] font-medium leading-7 text-white/82 sm:mt-6 sm:text-[15px] sm:leading-7">
                ...
                return (
                  ...
                  >
                    ...
                    <div className="min-w-0">
                      ...
                      <p className="mt-2 text-[12px] font-bold leading-5 text-[#27314f]/82">
                        {item.label}
                      </p>
                    </div>
                  </div>
          ...
          <div className="relative mx-auto grid max-w-[1320px] items-center gap-10 sm:gap-12 lg:grid-cols-[0.95fr_1.05fr] lg:gap-14">
            ...
            <div className="relative pb-6">
              ...
              <div className="relative min-h-[390px] w-full overflow-hidden rounded-[24px] bg-[linear-gradient(145deg,#07112f_0%,#20105c_55%,#7d1d72_100%)] shadow-[0_30px_70px_rgba(15,12,57,0.20)] sm:min-h-[430px] sm:w-[92%] sm:rounded-[30px]">
                ...
                <div className="pointer-events-none absolute -bottom-24 -right-20 h-80 w-80 rounded-full bg-[#ff2f7d]/35 blur-[95px]" />
                ...
                <div className="relative z-10 flex min-h-[390px] flex-col p-5 text-white sm:min-h-[430px] sm:p-10">
                  ...
                  <p className="mt-6 max-w-[420px] pr-0 text-[14px] font-medium leading-7 text-white/82 sm:mt-8 sm:pr-6 sm:text-[15px] sm:leading-7">
              ...
              <div className="relative z-20 -mt-12 ml-auto w-[94%] rounded-[21px] border border-[#e4dff2] bg-white p-5 shadow-[0_25px_60px_rgba(32,22,92,0.15)] sm:-mt-16 sm:w-[78%] sm:rounded-[25px] sm:p-7">
                ...
                <p className="mt-4 text-[11px] font-bold uppercase tracking-[0.18em] text-[#ff2f7d]">
                  <TypewriterText
            ...
            <div>
              ...
              <p className="mt-6 max-w-[630px] text-[16px] font-medium leading-8 text-[#27314f]/88">
              ...
              <p className="mt-5 max-w-[630px] text-[16px] font-medium leading-8 text-[#27314f]/88">
                ...
                {[
                  ...
                  return (
                    ...
                    >
                      ...
                      <p className="mt-2 text-[13px] font-medium leading-6 text-[#27314f]/82">
                        {item.text}
                      </p>
                    </div>
                  );
        ...
        <section className="px-4 py-14 sm:px-6 sm:py-18 lg:px-10 lg:py-24">
          <div className="mx-auto grid max-w-[1320px] gap-10 sm:gap-12 lg:grid-cols-[0.8fr_1.2fr] lg:items-center lg:gap-14">
            <div>
              ...
              <p className="mt-6 max-w-[570px] text-[16px] font-medium leading-8 text-[#27314f]/88">
            ...
            <div className="relative z-10 grid min-w-0 gap-10 lg:grid-cols-[minmax(0,1.05fr)_minmax(0,0.95fr)] lg:gap-12 xl:grid-cols-[minmax(0,1fr)_minmax(0,1fr)]">
              <div>
                ...
                <h2 className="mt-4 max-w-[720px] overflow-visible font-bold tracking-[-0.04em]">
                  ...
                  <span className="mt-1 flex items-baseline overflow-visible text-[28px] leading-[1.16] min-[390px]:text-[30px] sm:hidden">
                    ...
                    <TypewriterText
                      ...
                      delay={220}
                      nowrap
                      className="ml-2 pb-[0.04em] pr-[0.06em] text-[#ff2f7d]"
                      cursorClassName="bg-[#ff2f7d]"
                    />
                  </span>
                  ...
                  <span className="mt-1 flex overflow-visible pb-[0.1em] text-[28px] leading-[1.16] min-[390px]:text-[30px] sm:hidden">
                    <TypewriterText
                      ...
                      delay={1050}
                      nowrap
                      className="pb-[0.06em] pr-[0.08em] text-[#ff2f7d]"
                      cursorClassName="bg-[#ff2f7d]"
                    />
                  </span>
                  ...
                  <span className="mt-2 hidden items-baseline whitespace-nowrap text-[38px] leading-[1.14] sm:flex lg:text-[37px] xl:text-[40px]">
                    ...
                    <TypewriterText
                      ...
                      delay={220}
                      nowrap
                      className="ml-2 overflow-visible pb-[0.06em] pr-[0.08em] tracking-[-0.015em] text-[#ff2f7d]"
                      cursorClassName="bg-[#ff2f7d]"
                    />
                  </span>
                </h2>

                <p className="mt-6 max-w-[550px] text-[16px] font-medium leading-7 text-white/82">
                ...
                <button
                  type="button"
                  onClick={openConsultation}
                  className="group mt-7 inline-flex w-full cursor-pointer items-center justify-center gap-3 rounded-[13px] bg-white px-6 py-4 text-[13px] font-bold text-[#081232] transition-all duration-300 hover:-translate-y-1 sm:mt-8 sm:w-auto"
                >
                  Meet Our Approach
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-center justify-between">
                        <div className="flex h-[68px] w-[68px] items-center justify-center rounded-full bg-gradient-to-br from-[#4b22ff] to-[#ff2f7d] text-white shadow-[0_14px_30px_rgba(75,34,255,0.22)] transition-transform duration-300 group-hover:rotate-6 group-hover:scale-105">
                          <Icon size={27} />
                        </div>
        ...
        <section className="px-4 pb-8 sm:px-6 lg:px-10">
          <div className="relative mx-auto max-w-[1320px] overflow-hidden rounded-[22px] bg-[linear-gradient(105deg,#061330_0%,#17104b_42%,#5e155b_75%,#ff2f7d_125%)] px-5 py-10 text-white shadow-[0_24px_60px_rgba(11,10,48,0.24)] sm:rounded-[28px] sm:px-8 sm:py-12 lg:px-14">
            ...
            <div className="relative z-10 flex flex-col items-start justify-between gap-8 lg:flex-row lg:items-center">
              <div>
                ...
                <p className="mt-3 max-w-[690px] text-[15px] font-medium leading-7 text-white/84">
